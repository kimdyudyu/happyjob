		...
		<dl>
			...
			<dd class="content">
					...
					<table class="row" id="">
						...
						<tbody>
							...
							<tr>
								...
								<td><select id="p_searchareaDetail" name="p_searchareaDetail"
							...
							<tr>
								...
								<td>
									<div id="LanguageCD">
										<span>
											...
											<p>
												<input type="checkbox" id="cppCheck" name="skill_P" value="c++"> <label
													for="cppCheck">C++</label>
											</p>
											<p>
												<input type="checkbox" id="csharpCheck" name="skill_P" value="c#"> <label
											...
											<p>
												<input type="checkbox" id="delphiCheck" name="skill_P" value="delphi"> <label
											...
											<p>
												<input type="checkbox" id="netCheck" name="skill_P" value=".net"> <label
											...
											<p>
												<input type="checkbox" id="powerCheck" name="skill_P" value="powerbuilder"> <label
								...
								<td>
									<div id="webCD">
										<span>
											...
											<p>
												<input type="checkbox" id="miCheck" name="skill_P" value="miplatform"> <label
													for="miCheck">miPaltform</label>
											</p>
											<p>
												<input type="checkbox" id="xCheck" name="skill_P" value="xplatform"> <label
													for="xCheck">xPaltform</label>
											</p>
											<p>
												<input type="checkbox" id="nexaCheck" name="skill_P" value="nexacro"> <label
								...
								<td>
									<div id="OSCD">
										<span> 
											...
											<p>
												<input type="checkbox" id="solCheck" name="skill_P" value="solaris"> <label
													for="solCheck">SOLARIS</label>
											</p>
											<p>
												<input type="checkbox" id="winCheck" name="skill_P" value="windows"> <label
													for="winCheck">WINDOWS</label>
											</p>
											<p>
												<input type="checkbox" id="winServerCheck" name="skill_P" value="windowsserver"> <label
								...
								<td>
									<div id="FWCD">
										...
										<label>FrameWork</label>
											...
											<p>
												<input type="checkbox" id="egovCheck" name="skill_P" value="egov"> <label
													for="egovCheck">eGov</label>
											</p>
											<p>
												<input type="checkbox" id="strutsCheck" name="skill_P" value="struts"> <label
													for="strutsCheck">Struts</label>
											</p>
											<p>
												<input type="checkbox" id="jqueryCheck" name="skill_P" value="jquery"> <label
								...
								<td>
									<div id="DBCD">
										...
										<label>DB</label>
											<p>
												<input type="checkbox" id="accCheck" name="skill_P" value="access"> <label
								...
								<td>
									<div id="NTCD">
										...
										<label>Network</label>
											<p>
												<input type="checkbox" id="routerCheck" name="skill_P" value="ciscorouter"> <label
													for="routerCheck">Cisco Router</label>
											</p>
											<p>
												<input type="checkbox" id="swCheck" name="skill_P" value="ciscos-w"> <label
							...
							<tr>
								...
								<td colspan="1">초급&nbsp; <input type="text" name="add"
									id="add" class="add" style="width: 50px; height: 20px;" v-model="p_begin">
									&nbsp;명
								</td>
								<td colspan="1">중급&nbsp; <input type="text" name="add"
									id="add" class="add" style="width: 50px; height: 20px;" v-model="p_middle">
									&nbsp;명
								</td>
								<td colspan="1">고급&nbsp; <input type="text" name="add"
									id="add" class="add" style="width: 50px; height: 20px;" v-model="p_high">
									&nbsp;명
								</td>
								<td colspan="1">특급&nbsp; <input type="text" name="add"
									id="add" class="add" style="width: 50px; height: 20px;" v-model="p_special">
									&nbsp;명
								</td>
							</tr>
							...
							<tr>
								<th scope="row" style="width: 300px;" colspan="2">필수/우대사항</th>
							...
							<tr>
								...
								<td colspan="2">
									<input type="checkbox" id="telYn" value="0">전화면접 
									<input type="checkbox" id="dictYn" value="1">직접면접
								</td>
							</tr>
				...
				<div class="btn_areaC mt30" id="updateoption">
					...
					<a class="btnType blue" id="apply_p" @click="apply_func">
						<span>지원하기</span>
					</a> 
