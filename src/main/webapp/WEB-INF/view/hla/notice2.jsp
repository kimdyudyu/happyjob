...
<script type="text/javascript">
	...
	function board_search(currentPage) {
		...
		callAjax("/hla/noticeList.do", "post", "text", true, param,
				resultCallback);
	...
	function fdetailModal(nt_no) {
		...
		callAjax("/hla/detailNoticeList.do", "post", "json", true, param,
				resultCallback2);
		//alert("공지사항 상세 조회  22");
	}
	...
	function fSaveNotice() {
		...
		callAjax("/system/noticeSave.do", "post", "json", true, $("#myNotice")
	...
	function fDeleteNotice() {
		...
		if (con) {
			...
			$("#action").val("D"); // delete
			callAjax("/system/noticeSave.do", "post", "json", true, $(
						...
						<div class="content">
							...
							<p class="Location">
								<a href="#" class="btn_set home">메인으로</a> <a href="#"
									class="btn_nav">학습지원</a> / <a href="/hla/notice.do"><span
									class="btn_nav bold">공지사항</span></a><a href="/hla/notice.do"
							...
							<table>
								...
								<tr>
									...
									<td><a href="" class="btnType blue" id="searchBtn"
										name="btn"><span>검 색</span></a></td>
