...
<!-- 공지사항 상세보기 모달팝업 -->
<div id="TmDetailvue" class="layerPop layerType2" style="width: 1100px; hight: 1000px;">
					...
					<table class="row" id="detailtable"><!--  id="detailtable"  -->
						...
						<!-- <tbody> -->
							...
							<tr>
								...
								<th scope="row">등록일 </th>
								<td><input type="text" class="inputTxt p100" name="reg_date" id="d_enr_date" v-model="reg_date"/>
								</td>
							</tr>
							<tr >
							...
							<tr>
								...
								<td colspan="5">
									<div v-if="fileupdateset">
										<div v-if="filename !='' & filename != null" id="filearea" @click="DownloadQnaFileEvent" >
