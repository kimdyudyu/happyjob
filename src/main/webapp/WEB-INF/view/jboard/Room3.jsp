...
<script>
	...
	function init(){
		...
		searchVue = new Vue({
			...
			methods:{
				...
				searchbtn:function(){
					console.log("searchKey : "+this.searchkey+"    and    searchword :  "+this.searchword);
	...
	function fInsertReply(){
		...
		callAjax("/jboard/insertReply.do", "post", "json", true, param,resultCallback);
				...
				<li class="contents">
					...
					<div class="content">
						...
						<p class="Location">
								...
								<a href="#" class="btn_nav">게시판</a> 
								<span class="btn_nav bold">자료게시판</span> 
