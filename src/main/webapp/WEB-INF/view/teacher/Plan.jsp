...
<link rel="stylesheet" type="text/css"
	href="/js/jquery-ui/jquery-ui-1.11.4/jquery-ui.css">
<link rel="stylesheet" type="text/css"
	href="/js/jquery-ui/jquery-ui-1.11.4/jquery-ui.min.css">
<link rel="stylesheet" type="text/css"
	href="/css/vuecss/bootstrap-datepicker3.css">
<link rel="stylesheet" type="text/css"
	href="/css/vuecss/bootstrap-datepicker3.min.css">
<link rel="stylesheet" type="text/css"
	href="/css/vuecss/bootstrap-datepicker3.standalone.min.css">
<link rel="stylesheet" type="text/css"
	href="/css/vuecss/bootstrap-datepicker3.standalone.css">
<link rel="stylesheet" type="text/css"
	href="/js/bootstrap/custom_bootstrap.css">
...
<script type="text/javascript" charset="utf-8"
	src="/js/jquery-ui/jquery-ui-1.11.4/jquery-ui.js"></script>
<script type="text/javascript" charset="utf-8"
	src="/js/jquery-ui/jquery-ui-1.11.4/jquery-ui.min.js"></script>
<script type="text/javascript" charset="utf-8"
...
<script type="text/javascript"
	src="//rawgit.com/wenzhixin/vue-bootstrap-table/develop/docs/static/dist/vue-bootstrap-table.js"></script>
<style type="text/css">
	...
	<form id="myForm" action="" method="">
		...
		<div id="wrap_area">
			...
			<div id="container">
				<ul>
					<li class="lnb">
						<!-- lnb 영역 --> <script type="text/javascript">
							/** OnLoad event */
							$(function() {
								//fSelectMngrWorkStat();
							});
						...
						<div id="lnb_area">
							<div class="logo">
								<div id="header">
									<a class="logo" href="/jmli//mainPage.do"> <img
										src="/images/admin/comm/happy.jpg" alt="메인페이지" width="80%"
										height="55px"></a>
								</div>
							</div>

							<div class="login">
								<img src="/images/admin/comm/left_myImg.jpg" class="LoginImg"
									alt="사진"> <span class="LoginName">admin</span>
							...
							<ul class="lnbMenu">
								...
								<li>
									<dl>
										<dt>
											<a class="lnbBtn menu000" href="#">학습지원<em></em></a>
										</dt>
										<dd style="display: none;">
											<a href="/supportA/notice.do" id="lnb_notice">- 공지사항</a> <a
												href="/hla/adviceMgt.do" id="lnb_adviceMgt">- 수강 상담 이력</a> <a
												href="/supportA/awardMgt.do" id="lnb_awardMgt">- 상장관리</a>
										</dd>
									</dl>
								</li>
								...
								<li>
									<dl>
										<dt>
											<a class="lnbBtn menu000" href="#">학습관리<em></em></a>
										</dt>
										<dd style="display: none;">
											<a href="/manageA/lectureMgt.do" id="lnb_lectureMgt">-
												수강목록관리</a> <a href="/manageA/surveyMgt.do" id="lnb_surveyMgt">-
												설문관리</a> <a href="/manageA/exquestionMgt.do"
												id="lnb_exquestionMgt">- 시험문제관리</a> <a
												href="/manageA/exsubjectMgt.do" id="lnb_exsubjectMgt">-
												시험대상자관리</a>
										</dd>
									</dl>
								</li>
								...
								<li>
									<dl>
										<dt>
											<a class="lnbBtn menu000" href="#">인원관리<em></em></a>
										</dt>
										<dd style="display: none;">
											<a href="/peopleA/studentMgt.do" id="lnb_studentMgt">-
												학생관리</a> <a href="/peopleA/professorMgt.do"
												id="lnb_professorMgt">- 강사관리</a>
										</dd>
									</dl>
								</li>
								...
								<li>
									<dl>
										<dt>
											<a class="lnbBtn menu000" href="#">취업관리<em></em></a>
										</dt>
										<dd style="display: none;">
											<a href="/hla/careerInfo.do" id="lnb_careerInfo">- 취업정보</a> <a
												href="/careerA/resumeMgt.do" id="lnb_resumeMgt">- 이력서 관리</a>
										</dd>
									</dl>
								</li>
								...
								<li>
									<dl>
										<dt>
											<a class="lnbBtn menu000" href="#">물품관리<em></em></a>
										</dt>
										<dd style="display: none;">
											<a href="/product/roomList.do" id="lnb_roomList">- 강의실관리</a>
										</dd>
									</dl>
								</li>
								...
								<li>
									<dl>
										<dt>
											<a class="lnbBtn menu000 on" href="#">공통코드<em></em></a>
										</dt>
										<dd style="display: block;">
											<a href="/system/comnCodMgr.do" id="lnb_comnCodMgr"
												style="color: rgb(255, 255, 255);">- 공통코드관리</a>
										</dd>
									</dl>
								</li>
								...
								<li>
									<dl>
										<dt>
											<a class="lnbBtn menu000" href="#">통계<em></em></a>
										</dt>
										<dd style="display: none;">
											<a href="/statistics/satisfaction.do" id="lnb_satisfaction">-
												만족도</a> <a href="/statistics/studentNum.do" id="lnb_studentNum">-
												수강인원</a> <a href="/statistics/failedNum.do" id="lnb_failedNum">-
												과락인원</a>
										</dd>
									</dl>
								</li>
...
<script type="text/javascript">
   ...
   <body>
			...
			<div class="content">
			                      ...
			                      <p class="conTitle" style="padding-top: 29px;">
								        <select style="margin-left: 30px;">
								          <option>제목</option>
								          <option>강사명</option>
								          <option>과목</option>
								        </select>
								        <input class="keyword" type="text" name="search" maxlength="255" val="" style="width: 300px; height: 25px; margin-left: 13px;">
								        <a style="margin-left: 30px;">작성일</a>
								        <input type="date" value="" style="height:25px; margin-left: 20px; width: 140px;">
								        <a style="margin-left: 10px;">~</a>
								        <input type="date" value="" style="height:25px; margin-left: 10px; width: 140px;">
								        <input class="search" type="button" id="search" value="search" style="height:25px; margin-left: 15px; width:73px;">
								    </p>
								    
								    <a class="btnType3 color6" href="javascript:fPopModalComnGrpCod('surveyPoint');" style="height:31px; margin-left: 937px;"><span>계획서 등록</span></a>
								    <br><br>
									...
									<div class="divComGrpCodList">
										        <table class="col">
										            ...
										            <tbody >
										                <tr>
										                <td><input type="checkbox" name="chk_v" value="checked"></td>
										                <td></td>
										                <td></td>
										                <td></td>
										                <td></td>
			...
			<dl>
				...
				<dd class="content">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3"><input type="text" class="inputTxt p100"
									name="grp_tmp_fld_02" id="grp_tmp_fld_02" style="height:100px;"></td>
							</tr>
							<tr>
								<th scope="row">출석</th>
								<td colspan="3"><input type="text" class="inputTxt p100"
									name="grp_tmp_fld_03" id="grp_tmp_fld_03" style="height:100px;"></td>
							</tr>
							<tr>
					...
					<div class="btn_areaC mt30">
						<a href="" class="btnType blue" id="btnSaveGrpCod" name="btn"><span>수정</span></a>
