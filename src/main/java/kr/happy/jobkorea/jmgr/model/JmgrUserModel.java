package kr.happy.jobkorea.jmgr.model;

import java.util.Date;


/* 작성일 : 2020-05-14  /  작성자 : 정성규   
 * 사용자관리 VO 변수 추가
 * tb_userInfo 테이블 컬럼 변경 시 수정 필요
 */
public class JmgrUserModel {
	...
	private String mgr_tel3;// 담당자 번호
